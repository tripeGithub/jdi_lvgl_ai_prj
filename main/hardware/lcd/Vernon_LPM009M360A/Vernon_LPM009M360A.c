...
#include "Vernon_LPM009M360A/Vernon_LPM009M360A.h"

static const char *TAG = "lcd_panel.LPM009M360A";
...
esp_err_t esp_lcd_new_panel_LPM009M360A(const esp_lcd_panel_io_handle_t io, const esp_lcd_panel_dev_st7789t_config_t *panel_dev_config, esp_lcd_panel_handle_t *ret_panel)
{
#if CONFIG_LCD_ENABLE_DEBUG_LOG
    esp_log_level_set(TAG, ESP_LOG_DEBUG);
#endif
    esp_err_t ret = ESP_OK;
    LPM009M360A_panel_t *LPM009M360A = NULL;
    ESP_GOTO_ON_FALSE(io && panel_dev_config && ret_panel, ESP_ERR_INVALID_ARG, err, TAG, "invalid argument");
    LPM009M360A = calloc(1, sizeof(LPM009M360A_panel_t));
    ESP_GOTO_ON_FALSE(LPM009M360A, ESP_ERR_NO_MEM, err, TAG, "no mem for LPM009M360A panel");
    ...
    switch (panel_dev_config->rgb_endian) {
    case LCD_RGB_ENDIAN_RGB:
        LPM009M360A->madctl_val = 0;
        break;
    case LCD_RGB_ENDIAN_BGR:
        LPM009M360A->madctl_val |= LCD_CMD_BGR_BIT;
        break;
    default:
        ESP_GOTO_ON_FALSE(false, ESP_ERR_NOT_SUPPORTED, err, TAG, "unsupported color space");
        break;
    ...
    switch (panel_dev_config->bits_per_pixel) {
    case 16: // RGB565
        LPM009M360A->colmod_cal = 0x55;
        fb_bits_per_pixel = 16;
        break;
    case 18: // RGB666
        LPM009M360A->colmod_cal = 0x66;
        // each color component (R/G/B) should occupy the 6 high bits of a byte, which means 3 full bytes are required for a pixel
        fb_bits_per_pixel = 24;
        break;
    default:
    ...
    LPM009M360A->io = io;
    LPM009M360A->fb_bits_per_pixel = fb_bits_per_pixel;
    LPM009M360A->reset_gpio_num = panel_dev_config->reset_gpio_num;
    LPM009M360A->reset_level = panel_dev_config->flags.reset_active_high;
    LPM009M360A->base.del = panel_st7789t_del;
    LPM009M360A->base.reset = panel_st7789t_reset;
    LPM009M360A->base.init = panel_st7789t_init;
    LPM009M360A->base.draw_bitmap = panel_st7789t_draw_bitmap;
    LPM009M360A->base.invert_color = panel_st7789t_invert_color;
    LPM009M360A->base.set_gap = panel_st7789t_set_gap;
    LPM009M360A->base.mirror = panel_st7789t_mirror;
    LPM009M360A->base.swap_xy = panel_st7789t_swap_xy;
    LPM009M360A->base.disp_on_off = panel_st7789t_disp_on_off;
    *ret_panel = &(LPM009M360A->base);
    ESP_LOGD(TAG, "new LPM009M360A panel @%p", LPM009M360A);
    // printf("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\r\n");
    return ESP_OK;
